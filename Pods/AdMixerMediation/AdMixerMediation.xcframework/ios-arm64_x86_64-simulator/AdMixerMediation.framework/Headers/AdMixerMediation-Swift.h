...
#ifndef ADMIXERMEDIATION_SWIFT_H
#define ADMIXERMEDIATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdMixerMediation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AMMBannerView (SWIFT_EXTENSION(AdMixerMediation)) <AMBannerAdDelegate>
...
@interface AMMBannerView (SWIFT_EXTENSION(AdMixerMediation)) <GADBannerViewDelegate>
...
SWIFT_CLASS("_TtC16AdMixerMediation15AMMInterstitial")
@interface AMMInterstitial : NSObject
...
@interface AMMInterstitial (SWIFT_EXTENSION(AdMixerMediation)) <GADFullScreenContentDelegate>
...
SWIFT_CLASS("_TtC16AdMixerMediation9AMMNative")
@interface AMMNative : NSObject
@property (nonatomic, readonly, copy) NSURL * _Nonnull icon;
@property (nonatomic, readonly, copy) NSString * _Nonnull title;
@property (nonatomic, readonly, copy) NSString * _Nullable image;
@property (nonatomic, readonly, copy) NSString * _Nullable video;
@property (nonatomic, readonly, strong) GADMediaContent * _Nullable mGADMediaContent;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull cta;
...
SWIFT_CLASS("_TtC16AdMixerMediation24AMMNativeAdViewContainer")
@interface AMMNativeAdViewContainer : UIView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)willMoveToWindow:(UIWindow * _Nullable)newWindow;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
...
@interface AMMNativeAdViewContainer (SWIFT_EXTENSION(AdMixerMediation)) <GADVideoControllerDelegate>
- (void)videoControllerDidEndVideoPlayback:(GADVideoController * _Nonnull)videoController;
@end

@class AMNative;

@interface AMMNativeAdViewContainer (SWIFT_EXTENSION(AdMixerMediation)) <AMNativeAdDelegate>
...
@interface AMMNativeAdViewContainer (SWIFT_EXTENSION(AdMixerMediation)) <GADNativeAdLoaderDelegate>
...
SWIFT_CLASS("_TtC16AdMixerMediation14AMMRewardVideo")
@interface AMMRewardVideo : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface AMMRewardVideo (SWIFT_EXTENSION(AdMixerMediation)) <GADFullScreenContentDelegate>
- (void)ad:(id <GADFullScreenPresentingAd> _Nonnull)ad didFailToPresentFullScreenContentWithError:(NSError * _Nonnull)error;
- (void)adWillPresentFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adDidDismissFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adDidRecordClick:(id <GADFullScreenPresentingAd> _Nonnull)ad;
...
@interface AMMRewardVideo (SWIFT_EXTENSION(AdMixerMediation)) <AMVideoAdDelegate>
...
SWIFT_CLASS("_TtC16AdMixerMediation20AMMVideoInterstitial")
@interface AMMVideoInterstitial : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface AMMVideoInterstitial (SWIFT_EXTENSION(AdMixerMediation)) <AMVideoAdDelegate>
...
SWIFT_CLASS("_TtC16AdMixerMediation12AMMVideoView")
@interface AMMVideoView : UIView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@interface AMMVideoView (SWIFT_EXTENSION(AdMixerMediation)) <AMVideoAdDelegate>
- (void)didLoadAdSuccess;
- (void)didLoadAdFailWith:(NSError * _Nullable)error;
- (void)didShowAdSuccess;
- (void)didSkipAd;
- (void)didTapAdViewMore;
@end
...
@interface AMMediation : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AMMediation * _Nonnull shared;)
+ (AMMediation * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC16AdMixerMediation14AMMediationSDK")
@interface AMMediationSDK : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
