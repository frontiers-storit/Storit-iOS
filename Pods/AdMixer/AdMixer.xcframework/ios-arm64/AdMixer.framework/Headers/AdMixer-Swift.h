...
#ifndef ADMIXER_SWIFT_H
#define ADMIXER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdMixer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7AdMixer8AMAdInfo")
@interface AMAdInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL("_TtP7AdMixer18AMBannerAdDelegate_")
...
@interface AMBannerAdInfo : AMAdInfo
@end

@class NSCoder;

SWIFT_CLASS("_TtC7AdMixer14AMBannerAdView")
@interface AMBannerAdView : UIView
...
@interface AMBannerAdView (SWIFT_EXTENSION(AdMixer)) <WKNavigationDelegate, WKUIDelegate>
...
SWIFT_CLASS("_TtC7AdMixer24AMBannerAdViewController")
@interface AMBannerAdViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7AdMixer11AMMediaView")
@interface AMMediaView : UIView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC7AdMixer8AMNative")
@interface AMNative : NSObject
...
SWIFT_PROTOCOL("_TtP7AdMixer18AMNativeAdDelegate_")
...
SWIFT_CLASS("_TtC7AdMixer14AMNativeAdInfo")
@interface AMNativeAdInfo : AMAdInfo
@end
...
SWIFT_CLASS("_TtC7AdMixer24AMRewardAdViewController")
@interface AMRewardAdViewController : AMBaseVideoViewController
@end


SWIFT_PROTOCOL("_TtP7AdMixer17AMVideoAdDelegate_")
@protocol AMVideoAdDelegate
@optional
...
SWIFT_CLASS("_TtC7AdMixer13AMVideoAdInfo")
@interface AMVideoAdInfo : AMAdInfo
@end


SWIFT_CLASS("_TtC7AdMixer13AMVideoAdView")
@interface AMVideoAdView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC7AdMixer23AMVideoAdViewController")
@interface AMVideoAdViewController : AMBaseVideoViewController
@end

@class NSURLSession;

SWIFT_CLASS("_TtC7AdMixer10AdMixerSDK")
@interface AdMixerSDK : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AdMixerSDK * _Nonnull shared;)
+ (AdMixerSDK * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)debugWithIsEnabled:(BOOL)isEnabled;
- (void)dismissAnimationWithIsAnimated:(BOOL)isAnimated;
- (void)closeButtonDelayWithIsEnabled:(BOOL)isEnabled;
